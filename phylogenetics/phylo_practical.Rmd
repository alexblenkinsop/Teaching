...
#filename <- file.path(data.dir,'faria_2019_AGC_misaligned.fasta')
...
#filename <- file.path(data.dir,'faria_2019_AGC.fasta')
...
## Root the tree and drop the root tip
...
#tre2 <- root(tre, outgroup = 'Ref.C.CD.2008.DRC345.MN178982',resolve.root=TRUE)
...
tre3 <- drop.tip(tre2,"Ref.C.ZA.04.04ZASK146.AY772699",rooted=TRUE)
#tre3 <- drop.tip(tre2,"Ref.C.CD.2008.DRC345.MN178982",rooted=TRUE)
plot(tre3, cex = 0.6, tip.color = cols)
add.scale.bar(x=0,y=0)
title("Rooted tree using neighbour-joining algorithm")
